...
export function Column({ column, tasks, deleteTask, updateTask, createTask, addTag }: ColumnProps) {
    ...
    return (
        <div
            ref={setNodeRef}
            style={style}
            className="glass-panel w-full h-full md:w-[300px] lg:w-[350px] md:min-w-[280px] md:flex-shrink-0 rounded-2xl flex flex-col p-3 md:p-4 transition-colors hover:bg-white/5"
        >
